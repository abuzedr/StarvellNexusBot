"""
CBT - CallBack Texts. Константы для Telegram клавиатуры StarVellBot
"""
...
SEND_TMPLT = "30"
"""Callback для отправки шаблона в ЛС StarVell.
...
BAN = "35"
"""Callback для активации режима ввода никнейма StarVell пользователя для добавления его в ЧС.

User-state: ожидается сообщение с никнеймом StarVell пользователя для добавления его в ЧС.
"""

UNBAN = "36"
"""Callback для активации режима ввода никнейма StarVell пользователя для удаления его из ЧС.

User-state: ожидается сообщение с никнеймом StarVell пользователя для удаления его из ЧС.
"""
...
instance_id: int - ID запуска StarVellBot.
"""
...
"""Callback для отправки сообщения в чат StarVell.
...
"""User-state: ожидается сообщение с изображением для выгрузки на сервер StarVell (чат).
"""

UPLOAD_OFFER_IMAGE = "upload_offer_image"
"""User-state: ожидается сообщение с изображением для выгрузки на сервер StarVell (лот).
"""
...
# Загрузка конфигов
DOWNLOAD_CFG = "73"
"""Callback для скачивания конфигов.
Использование: CBT.DOWNLOAD_CFG:which

which: main | autoResponse | autoDelivery
"""